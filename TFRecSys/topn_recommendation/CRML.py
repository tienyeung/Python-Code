...
class CRML:
    '''
    Hao Wu, Qimin Zhou, et al. Effective Metric Learning with Co-occurrence Embedding for Collaborative Recommendations, under reviews.
    '''
    ...
    def __init__(self, n_users, n_items, embed_dim=50, margin=1.5, scaling_factor=3 / 4, cooccurrence_cap=100, alpha=0, beta=0, master_learning_rate=0.001,
                 clip_norm=1.0, use_rank_weight=True, use_cov_loss=False, cov_loss_weight=10, random_seed=2018, mode='USER'):
        """
