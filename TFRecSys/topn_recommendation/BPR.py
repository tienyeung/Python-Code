...
class BPR:
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():  # , tf.device('/cpu:0'):
            ...
            # MF predict: u_i > u_j
            x = tf.reduce_sum(tf.multiply(user_emb, (pos_item_emb - neg_item_embs)), 2, keep_dims=True)
    ...
    def train(self, log, sampler, train, test, iters, top_k):
        ...
        for i in range(iters):
            ...
            while not sampler.is_empty():
                ...
                _, auc, loss = self.sess.run((self.optimizer, self.mf_auc, self.loss), {self.user_positive_items_pairs: ui_pos,
